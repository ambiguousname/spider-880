...
int main(int argc, char **argv) {
	...
	title->labelsize(36);
	Fl_Box* credits = new Fl_Box(20, 120, 260, 120, "By ambiguousname (w/ stargyaru)\nMade with:\nFLTK 1.3.8, libpng, libjpeg, SQLite,\nminiaudio, Meson, Python Faker,\nOpenSSL, libarchive, libxml2\nSee BUILD_LICENSES for licensing");
