...
HistoryRoriksendHTMLWindow::HistoryRoriksendHTMLWindow(int x, int y, int w, int h) : HTMLWindow(std::shared_ptr<HTMLNode>(&HistoryRoriksendHTMLWindowNamespace::html_1), x, y, w, h) {
